...
import (
	...
	"github.com/Abraxas-356/neurons/internal/iam"
	"github.com/Abraxas-356/neurons/internal/iam/apikey"
	"github.com/Abraxas-356/neurons/internal/iam/apikey/apikeyapi"
	"github.com/Abraxas-356/neurons/internal/iam/apikey/apikeyinfra"
	"github.com/Abraxas-356/neurons/internal/iam/apikey/apikeysrv"
	"github.com/Abraxas-356/neurons/internal/iam/auth"
	"github.com/Abraxas-356/neurons/internal/iam/auth/authinfra"
	"github.com/Abraxas-356/neurons/internal/iam/invitation"
	"github.com/Abraxas-356/neurons/internal/iam/invitation/invitationapi"
	"github.com/Abraxas-356/neurons/internal/iam/invitation/invitationinfra"
	"github.com/Abraxas-356/neurons/internal/iam/invitation/invitationsrv"
	"github.com/Abraxas-356/neurons/internal/iam/otp"
	"github.com/Abraxas-356/neurons/internal/iam/otp/otpinfra"
	"github.com/Abraxas-356/neurons/internal/iam/otp/otpsrv"
	"github.com/Abraxas-356/neurons/internal/iam/role/roleapi"
	"github.com/Abraxas-356/neurons/internal/iam/role/roleinfra"
	"github.com/Abraxas-356/neurons/internal/iam/role/rolesrv"
	"github.com/Abraxas-356/neurons/internal/iam/tenant/tenantapi"
	"github.com/Abraxas-356/neurons/internal/iam/tenant/tenantinfra"
	"github.com/Abraxas-356/neurons/internal/iam/tenant/tenantsrv"
	"github.com/Abraxas-356/neurons/internal/iam/user"
	"github.com/Abraxas-356/neurons/internal/iam/user/userapi"
	"github.com/Abraxas-356/neurons/internal/iam/user/userinfra"
	"github.com/Abraxas-356/neurons/internal/iam/user/usersrv"
...
type Container struct {
	// Repositories — exposed for modules that need read-only user lookups
	// (the gamification roster resolves emails to user ids).
