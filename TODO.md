...
- [x] **Leaderboard should show student's course**
...
- [x] **Student info visible on QR screen**
...
- [x] **Lockable benefits with variable pricing**
...
- [x] **Share code fallback (student -> teacher)**
