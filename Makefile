...
export POSTGRES_DB = neuronsdb
export POSTGRES_USER = neurons
export POSTGRES_PASSWORD = supersecret
export POSTGRES_HOST = localhost
export POSTGRES_PORT = 5490
...
# Local development secret only. Production must inject a real one.
export JWT_SECRET_KEY = dev-only-insecure-secret-change-me
export JWT_ISSUER = neurons
export JWT_AUDIENCE = neurons-api
...
CONTAINER_NAME = neurons-postgres
REDIS_CONTAINER_NAME = neurons-redis
